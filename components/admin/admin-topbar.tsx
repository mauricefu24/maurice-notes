  ...
  return (
    <header className="sticky top-0 z-10 border-b border-slate-100 bg-white/95 backdrop-blur">
      <div className="flex h-20 items-center gap-4 px-6 lg:px-8">
        <form action="/admin/posts" className="ml-auto flex w-full max-w-md items-center gap-2 rounded-md border border-slate-200 bg-white px-3">
          <Search className="h-4 w-4 text-muted-foreground" />
          <Input name="q" className="h-10 border-0 px-0 focus-visible:ring-0" placeholder="搜索文章、分类或作者" />
